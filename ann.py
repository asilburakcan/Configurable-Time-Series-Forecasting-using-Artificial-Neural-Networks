...
#
#    def plot_full_and_zoom(train_dates, train_actual, pred_dates, pred_actual, pred_forecast, split_date, symbol, rmse):
#        import matplotlib.pyplot as plt
#
#        # --- FULL GRAPH (Train + Holdout actual + Forecast) ---
#        plt.figure(figsize=(13, 6))
#
#        # Actual full (train + holdout actual)
...
#
#        # Forecast only on predicted zone
...
#
#        # Error segments ONLY on predicted zone
...
#        plt.show()
#
#        # --- ZOOM GRAPH (Only predicted zone) ---
#        plt.figure(figsize=(13, 6))
...
#
#    # Your 3 knobs
#    offset_back = int(input("1) Go back from LAST by how many points? (e.g. 500): ").strip() or "500")
...
#
#    # -----------------------------
#    # Core slicing (this is THE thing you wanted)
#    # -----------------------------
#    N = len(close)
#    split_idx = N - offset_back  # forecast start index (split)
...
#        print(f"Not enough history. Need at least back_points={back_points} before split.")
#        return
#
#    # Forecast window must exist in data to compare (otherwise no RMSE)
#    max_h = N - split_idx
#    if horizon > max_h:
...
#        print("Holdout slice too small. Increase horizon or offset_back.")
#        return
#
#    train_series = train_close.values.astype(float)
#    holdout_actual = holdout_close.values.astype(float)
#
#    # Build supervised ONLY on train slice
...
#
#    # Sanity metrics on in-train splits
#    model.fit(X_tr, y_tr)
